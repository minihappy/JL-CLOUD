...
<script>
    export default {
        ...
        methods: {
            getMenuTree() {
                this.$axios.get("/sys-comm/sys/menu/list").then(res => {
            ...
            submitForm(formName) {
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        this.$axios.post('/sys-comm/sys/menu/' + (this.editForm.id ? 'update' : 'save'), this.editForm, {
                            headers: {
            ...
            editHandle(id) {
                this.$axios.get('/sys-comm/sys/menu/info/' + id).then(res => {
            ...
            delHandle(id) {
                this.$axios.post("/sys-comm/sys/menu/delete/" + id).then(res => {
                    this.$message({
                        showClose: true,
                        message: '恭喜你，操作成功',
                        type: 'success',

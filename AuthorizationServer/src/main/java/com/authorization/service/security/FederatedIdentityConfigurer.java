...
// */
//package com.authorization.service.security;
//
...
//
//	private String authorizationRequestUri;//授权请求的服务器
//
//	private Consumer<OAuth2User> oauth2UserHandler;//oauth2登录用户处理器
//
//	private Consumer<OidcUser> oidcUserHandler;//openid登录用户处理器
//
//	/**
//	 * @param loginPageUrl The URL of the login page, defaults to {@code "/login"}
//	 * @return This configurer for additional configuration
//	 */
//	public FederatedIdentityConfigurer loginPageUrl(String loginPageUrl) {//设置自定义的登录页，默认登录页为/login
...
//	 * @return This configurer for additional configuration
//	 */
//	public FederatedIdentityConfigurer authorizationRequestUri(String authorizationRequestUri) {//设置自定义的认证路径，默认路径为"/oauth2/authorization/{registrationId}
...
//	 * @return This configurer for additional configuration
//	 */
//	public FederatedIdentityConfigurer oauth2UserHandler(Consumer<OAuth2User> oauth2UserHandler) {//设置自定义的oauth2登录用户处理器
...
//	 * @return This configurer for additional configuration
//	 */
//	public FederatedIdentityConfigurer oidcUserHandler(Consumer<OidcUser> oidcUserHandler) {//设置默认的openid登录用户的处理器
...
//	// @formatter:off
//	@Override
//	public void init(HttpSecurity http) throws Exception {//实例化对象时从spring上下文获取客户端仓库
...
//				exceptionHandling.authenticationEntryPoint(authenticationEntryPoint)//有认证异常就跳转到oauth2登录页
//			)

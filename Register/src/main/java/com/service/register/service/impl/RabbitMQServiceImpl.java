...
import com.service.register.service.RabbitMQService;
...
//        }
    ...
    public String sendMsgByTopicExchange(String msg, String routingKey) throws Exception {
        try {
            Map<String, Object> map = msgToMap(msg);
            rabbitTemplate.convertAndSend(RabbitMQConfig.Register.RABBITMQ_REGISTER_SENT_MAIL_TOPIC_EXCHANGE, routingKey, map);
            return "ok";
        } catch (Exception e) {
            e.printStackTrace();
            return "error";
